...
public class MovieListActivity extends AppCompatActivity {
    ...
    //the paramater name for the API key
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize the adapter -the movies array cannot be reinitialized after this point
    ...
    //get the list of currently playing movoies from the API
